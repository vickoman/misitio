...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Votos'
        db.create_table(u'main_votos', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('candidato', self.gf('django.db.models.fields.related.ForeignKey')(related_name='votos_candidatos', to=orm['main.Candidato'])),
            ('user', self.gf('django.db.models.fields.related.OneToOneField')(related_name='votos_usuario', unique=True, to=orm['auth.User'])),
            ('voto', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
        ))
        db.send_create_signal(u'main', ['Votos'])
    ...
    models = {
        ...
        u'main.votos': {
            ...
            'candidato': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'votos_candidatos'", 'to': u"orm['main.Candidato']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'user': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'votos_usuario'", 'unique': 'True', 'to': u"orm['auth.User']"}),
